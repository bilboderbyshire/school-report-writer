...
# Copy from toplevel settings
COPY_FROM_TOPLEVEL_WIDTH = 600
COPY_FROM_TOPLEVEL_HEIGHT = 400
COPY_FROM_TOPLEVEL_GEOMETRY = f"{COPY_FROM_TOPLEVEL_WIDTH}x{COPY_FROM_TOPLEVEL_HEIGHT}"
...
LIGHT_SEPERATOR_COLOR = ("#DDDDDE", "#3E4249")
BAD_COLOR = "#A63D3A"
